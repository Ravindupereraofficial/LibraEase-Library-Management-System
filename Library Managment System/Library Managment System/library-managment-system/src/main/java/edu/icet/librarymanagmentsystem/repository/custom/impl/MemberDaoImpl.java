...
public class MemberDaoImpl implements MemberDao {
    ...
    private static final String INSERT_MEMBER_SQL = "INSERT INTO librarymembers (MemberID, Name, ContactInfo, MembershipDate) VALUES (?, ?, ?, ?)";
    private static final String SELECT_LAST_MEMBER_ID_SQL = "SELECT MemberID FROM librarymembers ORDER BY MemberID DESC LIMIT 1";
    private static final String SELECT_ALL_MEMBERS_SQL = "SELECT * FROM librarymembers";
    private static final String DELETE_MEMBER_SQL = "DELETE FROM librarymembers WHERE MemberID = ?";
    private static final String SELECT_MEMBER_BY_ID_SQL = "SELECT * FROM librarymembers WHERE MemberID = ?";
    private static final String UPDATE_MEMBER_SQL = "UPDATE librarymembers SET Name = ?, ContactInfo = ?, MembershipDate = ? WHERE MemberID = ?";
